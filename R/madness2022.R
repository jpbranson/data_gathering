...
# Nate Silver Data
#download.file('https://projects.fivethirtyeight.com/march-madness-api/2022/madness.json', "/Users/jbennett/Delta Health Alliance/Research - DHA Team Folder/Madness/madness.json")
x <- fromJSON(file="/Users/jbennett/Delta Health Alliance/Research - DHA Team Folder/Madness/madness.json")
...
tenthousand <- do.call(rbind,lapply(1:10000,Simulate))

# Now look at brackets

df <- read.csv("/Users/jbennett/Delta Health Alliance/Research - DHA Team Folder/Madness/qualtrics.csv", stringsAsFactors = FALSE)
...
write.csv(ptsreport, row.names = FALSE, file = '/Users/jbennett/Delta Health Alliance/Research - DHA Team Folder/Madness/ptsreport.csv')
